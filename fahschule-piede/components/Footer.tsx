                ...
                <div className="flex">
                    <Link href="https://de-de.facebook.com/pages/category/Automotive--Aircraft---Boat/Fahrschule-Piede-781753331871816/"  target="blank">
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-f"
                            className="w-2.5 mr-6 text-red-600" role="img" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 320 512">
                    ...
                    <Link href="https:/instagram.com/fahrschulepiede?igshid=YmMyMTA2M2Y=\" target="blank">
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram"
                            className="w-3.5 mr-6 text-red-600" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path fill="currentColor"
