        ...
        <footer className="text-center lg:text-left bg-box-blue text-gray-100">
            <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                ...
                <div className="flex justify-center">
                    <a href="https://de-de.facebook.com/pages/category/Automotive--Aircraft---Boat/Fahrschule-Piede-781753331871816/" className="mr-6 text-red-600" target="blank">
                    ...
                    <a href="https:/instagram.com/fahrschulepiede?igshid=YmMyMTA2M2Y=\" className="mr-6 text-red-600" target="blank">
          ...
          ">
                    ...
                    <div className="">
                        ...
                        <p className="mb-4">
                            <a href="#!" className="text-gray-100">Impressum</a>
                        </p>
                        <p className="mb-4">
