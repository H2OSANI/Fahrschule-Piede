    ...
    <>
      ...
      <div className='w-full min-h-screen p-8 bg-back-blue'>
        ...
        <div className='flex flex-col md:flex-row justiy-center w-full'>
          <div className='hidden md:w-1/2 bg-slate-600 md:rounded-l-xl object-cover'>
            <Image src="" layout='responsive' width="380px" height="280px" className='md:rounded-l-xl object-fit mix-blend-overlay' />
          </div>
          <h2 className='hidden pt-8 pb-8 text-red-600 text-4xl font-bold text-center'>Fahrschulen in Langdorf</h2>
          <div className='hidden md:w-1/2 bg-slate-600 md:rounded-r-xl'>
            <Image src="" layout='responsive' width="380px" height="280px" className='md:rounded-r-xl object-fit mix-blend-overlay' />
          </div>
        </div>
      </div>
    </>
