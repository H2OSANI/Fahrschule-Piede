                ...
                <table className="w-full hidden md:block px-4">
                    ...
                    <tbody className="divide-y divide-gray-200">
                        <tr className="bg-white">
                            <td className="p-3 text-xl text-gray-700 font-bold whitespace-nowrap">94209, Regen</td>
                        ...
                        <tr className="bg-white">
                            <td className="p-3 text-xl text-gray-700 font-bold whitespace-nowrap">94264, Langdorf</td>
                            <td className="p-3 text-xl text-gray-700 whitespace-nowrap">Zwieseler Straße 2</td>
